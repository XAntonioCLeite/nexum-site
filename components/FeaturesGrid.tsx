...
const FeaturesGrid: React.FC = () => {
  ...
  const card1 = (
    <div className="group relative min-h-[440px] md:min-h-[480px] rounded-3xl bg-[#0f1214] border border-white/10 hover:border-deepBlue/50 transition-all duration-500 overflow-hidden flex flex-col w-full">
      {/* Graphic Placeholder */}
      <div className="flex-1 relative overflow-hidden flex items-center justify-center bg-gradient-to-b from-transparent to-black/20 py-8">
         {/* Background Grid */}
      ...
      <div className="p-8 pt-6 mt-auto border-t border-white/5 bg-[#0f1214] relative z-20">
        <h3 className="text-xl font-bold text-white mb-4">Processamento de Linguagem Natural</h3>
  ...
  const card2 = (
    <div className="group relative min-h-[440px] md:min-h-[480px] rounded-3xl bg-[#0f1214] border border-white/10 hover:border-blue-500/30 transition-all duration-500 overflow-hidden flex flex-col w-full">
      {/* Graphic Placeholder */}
      <div className="flex-1 relative overflow-hidden flex items-center justify-center py-8">
      ...
      {/* Card Footer */}
      <div className="p-8 pt-6 mt-auto border-t border-white/5 bg-[#0f1214] relative z-20">
        <h3 className="text-xl font-bold text-white mb-4">Ecossistema Integrado</h3>
        <p className="text-sm text-slate-400 leading-relaxed">
  ...
  const card3 = (
    <div className="group relative min-h-[440px] md:min-h-[480px] rounded-3xl bg-[#0f1214] border border-white/10 hover:border-yellow-500/30 transition-all duration-500 overflow-hidden flex flex-col w-full">
       {/* Graphic Placeholder */}
       <div className="flex-1 relative overflow-hidden p-8 flex items-center justify-center bg-gradient-to-b from-transparent to-yellow-900/5 py-8">
          {/* Checklist UI */}
      ...
      {/* Card Footer */}
      <div className="p-8 pt-6 mt-auto border-t border-white/5 bg-[#0f1214] relative z-20">
        <h3 className="text-xl font-bold text-white mb-4">Gestão Autônoma de No-Show</h3>
        <p className="text-sm text-slate-400 leading-relaxed">
